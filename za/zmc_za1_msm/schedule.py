...
log_file_path = "/home/giggo/python/logs/za1msm.log"
logging.basicConfig(
    level=logging.INFO,
...
schedule.every().day.at("09:00").do(lambda: run_script('/home/giggo/python/water-flow-prediction/za/zmc_za1_msm/rnn_update.py'))
schedule.every().day.at("09:01").do(lambda: run_script('/home/giggo/python/water-flow-prediction/za/zmc_za1_msm/rnn_predict.py'))
