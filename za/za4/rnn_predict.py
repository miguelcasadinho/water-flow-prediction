...
if __name__ == "__main__":
    ...
    model = load_model('/home/giggo/python/water-flow-prediction/za/za4/updated_flow_prediction_model.keras')
    ...
    plt.title('ZMC ZA4 - Flow Prediction')
    ...
    plt.tight_layout() 
    plt.show()
    plt.savefig('/home/giggo/python/water-flow-prediction/za/za4/predict.png')
