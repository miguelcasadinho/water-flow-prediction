...
if __name__ == "__main__":
    ...
    model = load_model('/home/giggo/python/water-flow-prediction/za/za3/updated_flow_prediction_model.keras')
    ...
    plt.title('ZMC ZA3 - Flow Prediction')
    ...
    plt.tight_layout() 
    plt.show()
    plt.savefig('/home/giggo/python/water-flow-prediction/za/za3/predict.png')
