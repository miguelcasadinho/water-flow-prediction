...
LOOKBACK_PERIOD = 96
MODEL_PATH = '/home/giggo/python/water-flow-prediction/za/za1_msm/updated_flow_prediction_model.keras'
UPDATED_MODEL_PATH = '/home/giggo/python/water-flow-prediction/za/za1_msm/updated_flow_prediction_model.keras'
timestamp = datetime.now().strftime("%Y:%m:%d_%H:%M")
UPDATED_MODEL_PATH_VERSION = f'/home/giggo/python/water-flow-prediction/za/za1_msm/models/model_{timestamp}.keras'
...
def dynamic_model_update():
    ...
    # Check if the dataset length is greater than 180 after preprocessing
    if dataset_size > 180:
        ...
        print(f"Dataset length after preprocessing is {dataset_size}, which is less than 180. Model update skipped.")
