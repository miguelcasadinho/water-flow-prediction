...
if __name__ == "__main__":
    ...
    model = load_model('/home/giggo/python/water-flow-prediction/za/za1_msm/updated_flow_prediction_model.keras')
    ...
    real_flow = dataset.iloc[97:, 0].values
    ...
    plt.title('ZMC ZA1-MSM - Flow Prediction')
    ...
    plt.tight_layout() 
    plt.show()
    plt.savefig('/home/giggo/python/water-flow-prediction/za/za1_msm/predict.png')