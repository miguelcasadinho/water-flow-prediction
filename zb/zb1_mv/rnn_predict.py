...
if __name__ == "__main__":
    ...
    model = load_model('/home/giggo/python/water-flow-prediction/zb/zb1_mv/updated_flow_prediction_model.keras')
    ...
    plt.tight_layout() 
    plt.show()
    plt.savefig('/home/giggo/python/water-flow-prediction/zb/zb1_mv/predict.png')
