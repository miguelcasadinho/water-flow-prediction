...
LOOKBACK_PERIOD = 96
MODEL_PATH = '/home/giggo/python/water-flow-prediction/zb/zb1_mv/updated_flow_prediction_model.keras'
UPDATED_MODEL_PATH = '/home/giggo/python/water-flow-prediction/zb/zb1_mv/updated_flow_prediction_model.keras'
timestamp = datetime.now().strftime("%Y:%m:%d_%H:%M")
UPDATED_MODEL_PATH_VERSION = f'/home/giggo/python/water-flow-prediction/zb/zb1_mv/models/model_{timestamp}.keras'
