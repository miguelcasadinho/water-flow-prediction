...
log_file_path = "/home/giggo/python/logs/zb1mv.log"
logging.basicConfig(
    level=logging.INFO,
...
schedule.every().day.at("01:02").do(lambda: run_script('/home/giggo/python/water-flow-prediction/zb/zmc_zb1_mv/rnn_update.py'))
schedule.every().day.at("01:03").do(lambda: run_script('/home/giggo/python/water-flow-prediction/zb/zmc_zb1_mv/rnn_predict.py'))
